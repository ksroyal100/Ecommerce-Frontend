              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="/">
                  ...
                  <img
                    ...
                    src="https://content.jdmagicbox.com/comp/ahmedabad/53/079pf007053/catalogue/v-mart-lawgarden-law-garden-ahmedabad-readymade-garment-retailers-yv50wp8ezk.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {auth.user?.firstName ? (
                   ...
                   <Avatar className='text-white cursor-pointer font-semibold'
                      onClick={handleUserClick}
                      aria-controls={open ? "basic-menu" : undefined}
                      aria-haspopup="true"
                      aria-expanded={open ? "true" : undefined}
                      sx={{ width: 46, height: 46, bgcolor: "#1565c0" }}>{auth.user?.firstName[0].toUpperCase()}</Avatar>
                      ...
                      <Menu
                       ...
                       >
                        ...
                        <MenuItem onClick={handleLogout}><span className='text-red-500'>Logout</span></MenuItem>
                      </Menu>
                    </>
                  ) : (
                      <Button onClick={handleOpen} className='text-sm font-medium text-gray-700 hover:text-gray-800 cursor-pointer'>
                        create account
                      </Button>
                    )}
