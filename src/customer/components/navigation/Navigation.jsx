                  ...
                  {auth.user?.firstName ? (
                    <div className="flow-root">
                      <div className="flex items-center space-x-2">
                        <Avatar
                          sx={{ width: 36, height: 36, bgcolor: "#1565c0" }}
                        >
                      ...
                      <button
                        ...
                        className="mt-6 block text-lg font-bold text-red-500"
                      >
                        Logout
                      </button>
                    </div>
                                              ...
                                              >
                                                <p
                                                  onClick={() =>{
                                                    ...
                                                    close(); // Close the Popover after clicking
                                                  }}
                  ...
                  {auth.user?.firstName ? (
                    <>
                      <Avatar
                        ...
                        sx={{ width: 46, height: 46, bgcolor: "#1565c0" }}
                      >
                        {auth.user?.firstName[0].toUpperCase()}
                      </Avatar>
