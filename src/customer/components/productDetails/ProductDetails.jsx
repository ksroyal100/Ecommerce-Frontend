    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <form className="mt-10">
              ...
              <div className="mt-10">
                ...
                <Button onClick={handleAddToCart} color='primary' variant='contained' sx={{px:"2rem", py:"1rem"}}>
                  Add To Cart 
                  </Button>
                  </div>
            </form>
        ...
        <section>
          ...
          <h1 className='flex font-semibold mb-4 text-lg pb-4'>Recent Review & Rating</h1>
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
               <h1 className='flex text-xl font-semibold pb-1'>Product Ratings</h1> 
